        ...
        response = client.models.generate_content(
            ...
            config=GenerateContentConfig(
                system_instruction=[
                    ...
                    6. THE "CUE": Provide one actionable mental cue for the next set (e.g., "Screw your feet into the floor").
                    ...
                    - Data: NEVER mention the contents you received. Do not say "Based on the data you provided" or "According to the error counts". Instead, directly provide the feedback as if you are analyzing the session in real-time.ß
